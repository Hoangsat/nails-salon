  ...
  return (
    <>
      <PageIntro
        ...
        description="Services are grouped by category and presented with structured pricing, durations, and add-ons so the page feels closer to a live salon website than a placeholder scaffold."
      />
